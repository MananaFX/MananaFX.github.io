...
3. ##### 方式1（选通的输入/输出方式）
   ...
   - INTR(Interrupt Request)：**输出**，**中断请求信号**，**/STB=1**、IBF=1、INTE=1时，置为高电平，向CPU发出**中断请求信号**；读信号**/RD下降沿**将INTE置为**低电平**，即CPU**开始读**时，结束中断请求信号
     ...
     ![](https://raw.githubusercontent.com/MananaFX/CDN/main/post/202205222347088.jpg?token=AYWBIY3PMKCPDRED4SFGXTDCRJNTI)
   ...
   - INTR(Interrupt Request)：**输出**，**中断请求信号**，**/ACK=1**、**/**OBF=1、INTE=1时，置为高电平，向CPU发出**中断请求信号**；写信号**/WR下降沿**将INTE置为**低电平**，即CPU**开始写**时，结束中断请求信号
     ...
     ![](https://raw.githubusercontent.com/MananaFX/CDN/main/post/202205222347338.jpg?token=AYWBIY5IZ6THVWJXEMSYYK3CRJNTM)
   ...
   <img src="https://raw.githubusercontent.com/MananaFX/CDN/main/post/202205222347137.png?token=AYWBIYZ26IU2OEGDL2EPFF3CRJNTQ" alt="image-20220501123054772" style="zoom: 50%;" />
...
4. ##### 方式2（带有选通信号的双向I/O方式）
   ...
   3. /ACK：外设已将数据读走
      ...
      ![](https://raw.githubusercontent.com/MananaFX/CDN/main/post/202205222349679.jpg?token=AYWBIY2KC43NKDGRU63DSWDCRJN24)
   ...
   ​	![image-20220501123122152](https://raw.githubusercontent.com/MananaFX/CDN/main/post/202205222347704.png?token=AYWBIYYQ6IP7LFUK2U4RH7TCRJNT2)
...
- ![image-20220503160148915](https://raw.githubusercontent.com/MananaFX/CDN/main/post/202205222347295.png?token=AYWBIY2M4JH3EC4YR4SPVZLCRJNT4)
