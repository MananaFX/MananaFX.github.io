  ...
  <div class="toLoveStory left">
    <el-container >
      <el-header>
        ...
        <el-row :gutter="24" justify="center">
          <el-col :span="24">
            <Countdown deadline="2022-05-20 00:00:00" :timeElapsed="itsTime"/>
          </el-col>
        </el-row>
        <el-row :gutter="24" justify="center">
        <el-button-group>
    ...
    >
      <span>接下来你将看到，可怜的nana是怎么完成这份520礼物的，当然这只是一部分~点击确认你将打开一段视频，我会将他倍速录制，这样子你很快就可以看完啦~我爱你！也很珍惜你，真的！</span>
      <template #footer>
    ...
    >
      ...
      <template #footer>
      <span class="dialog-footer">
        <el-button @click="PasswordVisible = false">不选了，我知道密码了</el-button>
